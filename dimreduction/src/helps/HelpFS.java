...
public class HelpFS extends javax.swing.JFrame {
    
    public HelpFS() {
        initComponents();
        try{
            jTextPane1.setPage(getClass().getResource("/helps/single-execution.html"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Help - Single Execution Panel");
