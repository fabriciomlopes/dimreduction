...
public class HelpCV extends javax.swing.JFrame {
    
    public HelpCV() {
        initComponents();
        try{
            jTextPane1.setPage(getClass().getResource("/helps/cross-validation.html"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Help - Cross Validation Panel");
